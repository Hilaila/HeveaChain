...
Version simulation uniquement.
Aucun moteur ni outil agricole réel n'est commandé.
"""
...
class PlantationMap:
    ...
    def visit_tree(self, tree_id: int) -> bool:
        """
        Déplace le robot vers l'arbre puis
        marque celui-ci comme visité.
        """
...
def demo():
    """Petite démonstration du système de cartographie."""

    plantation = PlantationMap()

    # Quelques arbres de démonstration.
